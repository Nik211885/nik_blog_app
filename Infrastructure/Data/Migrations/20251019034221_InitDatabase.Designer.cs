...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20251019034221_InitDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Application.ValueObject.CommentReaction", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Application.ValueObject.PostReaction", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Application.ValueObject.CommentReaction", b =>
                {
                    ...
                    b.HasOne("Application.Entities.Comment", "Entity")
                        .WithMany()
            ...
            modelBuilder.Entity("Application.ValueObject.PostReaction", b =>
                {
                    b.HasOne("Application.Entities.Post", "Entity")
                        .WithMany()
                        .HasForeignKey("EntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
